...
#define ENC_S           16  // Encoder select pin
...
simpleThread_new_timebased_dynamic  (_sT_P2  , _sT_millis, 6000, _sT_stop ,  getStates);	// get state info ($G) (not supported from UniversalGcodeSender)
...
{ 
   Serial.begin(38400);   // open serial to PC
	...
	pinMode(ENC_S, INPUT_PULLUP);      // sets the encoder select digital pin
